// =============================================================================
// FirebaseSyncViewModel.kt  —  Room flows + connectivity → UI state; intents → writes + sync
//
...
import com.example.firebasesync.data.ConnectivityObserver
import com.example.firebasesync.data.Note
import com.example.firebasesync.data.NoteRepository
import com.example.firebasesync.sync.SyncScheduler
import kotlinx.coroutines.flow.SharingStarted
import kotlinx.coroutines.flow.StateFlow
import kotlinx.coroutines.flow.stateIn
import kotlinx.coroutines.launch

class FirebaseSyncViewModel(app: Application) : AndroidViewModel(app) {
        ...
        fun factory(app: Application): ViewModelProvider.Factory =
            object : ViewModelProvider.Factory {
                ...
                override fun <T : ViewModel> create(modelClass: Class<T>): T =
                    FirebaseSyncViewModel(app) as T
            }
    }
}
