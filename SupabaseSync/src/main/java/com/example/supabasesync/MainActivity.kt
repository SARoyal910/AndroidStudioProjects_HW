...
//   • data/CloudApi.kt        — REAL (Supabase) vs FAKE (offline) cloud + the switch
...
import com.example.supabasesync.ui.theme.SupabaseSyncTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            SupabaseSyncTheme {
                val vm: SupabaseSyncViewModel = viewModel(factory = SupabaseSyncViewModel.factory(application))
                SupabaseSyncApp(vm)
            }
        }
    }
...
@Composable
fun SupabaseSyncApp(vm: SupabaseSyncViewModel) {
    ...
    Scaffold(
        ...
        topBar = { TopAppBar(title = { Text("SupabaseSync") }) },
    ) { inner ->
