...
// Theme.kt
//
// Defines TestingBasicsTheme — the single Composable that wraps the entire app
...
// =============================================================================
package com.example.testingbasics.ui.theme
...
/**
 * TestingBasicsTheme — wrap the app's content in this to apply the design system.
 *
